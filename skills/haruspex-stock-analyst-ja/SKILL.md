...
- 各次元の 1 行説明には [`../../shared/DIMENSIONS.md`](../../shared/DIMENSIONS.md)
  を参照。
...
- **share URL を必ず含める** ことで、ユーザーが Haruspex のページで検証
  できるようにする。
- **免責事項を必ず含める** —
  [`../../shared/DISCLAIMER.md`](../../shared/DISCLAIMER.md) の日本語版
  を逐語的に。
...
- [`../../shared/DIMENSIONS.md`](../../shared/DIMENSIONS.md) — 16 次元の
  解説 (英語、共通)
- [`../../shared/DISCLAIMER.md`](../../shared/DISCLAIMER.md) — 免責事項
  (日本語版もここ)
- [`../../shared/MCP_SETUP.md`](../../shared/MCP_SETUP.md) — MCP サーバー
  のインストール手順 (英語、共通)
